...
<section id="SC_ret_tck" class="F1 R5 M20">
	...
	<div class="T_1 CLR">
		...
		<article>
			...
			<ul class="CLR">
				<li><a class="BT2 BLACK R5" href="index.php?page=retouch_steP4">RETOUCHER MAINTENANT</a></li>
			</ul>
		...
		<aside>
			...
			<ul class="ICO_PK2">
				<li>
					<div>72<span>H</span></div>
					<p>Réception<span>Retouche</span></p>
				</li>
				<li>
					<div>6.<span>49€</span></div>
					<p>Prix<span>Retouche</span></p>
				</li>
			</ul>

			<?php include ("template/ot/NAV_ret_pck.php") ?>