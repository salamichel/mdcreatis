...
<section id="SC_ret_tck" class="F1 R5 M20">
	...
	<div class="sl-slider">
		...
		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
			<div class="UCP">
				<img src="css/ret/E4/E4_1r.jpg">
				<img src="css/ret/E4/E4_1.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
			<div class="UCP">
				<img src="css/ret/E4/E4_2r.jpg">
				<img src="css/ret/E4/E4_2.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
			<div class="UCP">
				<img src="css/ret/E4/E4_3r.jpg">
				<img src="css/ret/E4/E4_3.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
			<div class="UCP">
				<img src="css/ret/E4/E4_4r.jpg">
				<img src="css/ret/E4/E4_4.jpg">		
			</div>
		</article>

		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
			<div class="UCP">
				<img src="css/ret/E4/E4_5r.jpg">
				<img src="css/ret/E4/E4_5.jpg">		
			</div>
		</article>

		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
			<div class="UCP">
				<img src="css/ret/E4/E4_6r.jpg">
				<img src="css/ret/E4/E4_6.jpg">		
			</div>
		</article>
    ...
    <div id="ret_PK1" class="FM_TKA1 CLR">
        ...
        <article>
            <h1>Modification <span>ENVIRONNEMENT</span></h1>
            <h2>Personnalisation (Secondaire)</h2>
            <p>Cette retouche concerne des corrections d'éléments environnementaux plus importantes qu'une retouche secondaire, prenant au minimum une charge de plusieurs heures de travail sur la photographie.</p>
            <div class="FM_TK-IF1">
